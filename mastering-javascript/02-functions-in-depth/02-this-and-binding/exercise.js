/**
 * Part 02, Lesson 02 — `this` and the Four Binding Rules
 *
...
export const PREDICTIONS = {
  ...
  'method pulled off the object, then called': 'TODO',

  // function show() { return this; }  ->  show.call(obj)
  'called with .call(obj)': 'TODO',

  // function show() { return this; }  ->  show.bind(obj)()
  'bound with .bind(obj), then called': 'TODO',

  // function Ctor() { this.x = 1; }  ->  new Ctor()
  'called with new': 'TODO',

  // const o = { m: () => this };  ->  o.m()
  'arrow written as an object property': 'TODO',

  // const o = { m() { return (() => this)(); } };  ->  o.m()
  'arrow written inside a method': 'TODO',

  // const bound = show.bind(a);  ->  bound.call(b)
  'bound function, then .call with a different object': 'TODO',
};
...
export function makeUser(name) {
  // TODO
  throw new Error('makeUser: not implemented');
}
...
export function getGreeter(user) {
  // TODO: bind, or wrap in an arrow
  throw new Error('getGreeter: not implemented');
}
...
export function makeTimer() {
  // TODO
  throw new Error('makeTimer: not implemented');
}
...
export function describeThis() {
  // TODO
  throw new Error('describeThis: not implemented');
}
...
export function borrowMethod(obj, fn, ...args) {
  // TODO
  throw new Error('borrowMethod: not implemented');
}
