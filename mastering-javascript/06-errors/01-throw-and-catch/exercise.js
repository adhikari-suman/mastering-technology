...
export function attempt(fn) {
  // TODO
  throw new Error('attempt: not implemented');
}
...
export function normaliseError(value) {
  // TODO
  throw new Error('normaliseError: not implemented');
}
...
export function withCleanup(fn, cleanup) {
  // TODO: this is what finally is for. Do not return from the finally block.
  throw new Error('withCleanup: not implemented');
}
...
export function swallowsError() {
  // TODO
  throw new Error('swallowsError: not implemented');
}
...
export function rethrowWithContext(fn, message) {
  // TODO
  throw new Error('rethrowWithContext: not implemented');
}
...
export function causeChain(error) {
  // TODO
  throw new Error('causeChain: not implemented');
}
...
export function isErrorLike(value) {
  // TODO
  throw new Error('isErrorLike: not implemented');
}
